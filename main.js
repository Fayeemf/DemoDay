...
function myApp(){
    ...
    function renderSearch() {
        $('.container-fluid').replaceWith('<h3 class="centertext">Find Activities Near You</h3><div class="row">    <h2 class="centertext">Search Key Words</h2><div id="custom-search-input"><div class="inputsearch input-group col-md-12"><input type="text" class="searchform search-query form-control" placeholder="Key Words: "Chelsea Market","Kids"" /><span class="input-group-btn"><button class="searchcenterbtn btn" type="submit">Search</button><span class=" glyphicon glyphicon-search"></span></span></div></div></div>');
        $('#map').css('height', '75vh');
